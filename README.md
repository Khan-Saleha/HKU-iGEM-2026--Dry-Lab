...
* Use a bright color gradient (like viridis). Plot two distinct markers on top of the map: a star marking the Bacterial Cellulose parameters, and a circle for your Hydrogel parameters.
